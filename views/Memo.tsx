...
import {
  Text, View, ScrollView, Image, Dimensions, TouchableOpacity, TextInput,
} from 'react-native';
    ...
    <View style={getStyle().container}>
      ...
      <View style={getStyle().header}>
        ...
        <View style={getStyle().filtersBar}>
          <TouchableOpacity
            style={[getStyle().filterButton, filters.f1 ? { backgroundColor: '#5c70c1' } : { backgroundColor: '#656566' }]}
            onPress={() => handleFilters('f1')}
          >
            <Text style={getStyle().buttonText}>À faire</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[getStyle().filterButton, filters.f2 ? { backgroundColor: '#c64e03' } : { backgroundColor: '#656566' }]}
            onPress={() => handleFilters('f2')}
          >
            <Text style={getStyle().buttonText}>Prioritaire</Text>
          </TouchableOpacity>
          <TouchableOpacity
            style={[getStyle().filterButton, filters.f3 ? { backgroundColor: '#9e0000' } : { backgroundColor: '#656566' }]}
